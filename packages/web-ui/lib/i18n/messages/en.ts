...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.releaseNotes": "Sec Web v{version} is available. View release notes",
    ...
    "sec.title": "SEC workspace",
    "sec.workspace.collapse": "Collapse security workspace",
    "sec.workspace.expand": "Expand security workspace",
    "sec.workspace.collapseShort": "Collapse",
    "sec.workspace.expandShort": "Expand",
    "sec.runtimeStarts": "The Sec runtime starts when the new session is first used.",
    "sec.loading": "Loading Sec profile…",
    "sec.error.invalidJson": "Profile API returned invalid JSON",
    "sec.error.invalidResponse": "Profile API returned an invalid response",
    "sec.error.httpStatus": "HTTP {status}",
    "sec.error.invalidSnapshot": "Sec profile returned an empty or invalid snapshot",
    "sec.error.sessionNotStarted": "Security session has not started",
    "sec.error.codingSession": "This session is a coding session; security commands are unavailable",
    "sec.error.invalidDiagnostics": "Sec diagnostics returned an invalid result",
    "sec.error.invalidEvent": "The real-time security state event was invalid",
    "sec.error.connectionFailed": "The real-time security state connection failed; the browser will retry",
    "sec.error.scopeRequired": "Provide at least one authorized target",
    "sec.error.authorizationRequired": "Provide an authorization source; attachments do not grant authorization automatically",
    "sec.error.autonomousIsolationRequired": "Autonomous mode requires a sandbox or controlled external isolation source",
    "sec.confirm.autonomous": "Autonomous mode may execute P2/P3 security actions inside the authorized scope. Confirm this controlled environment?",
    "sec.stage.notStarted": "not started",
    "sec.stage.understanding": "understanding",
    "sec.stage.planning": "planning",
    "sec.stage.recon": "reconnaissance",
    "sec.stage.analysis": "analysis",
    "sec.stage.verification": "verification",
    "sec.stage.response": "response",
    "sec.stage.report": "report",
    "sec.policy.mode.strict": "strict",
    "sec.policy.mode.competition": "competition",
    "sec.policy.mode.autonomous": "autonomous",
    "sec.policy.title": "Policy and isolation",
    "sec.policy.isolation": "Isolation: {status}",
    "sec.policy.isolationType": "Isolation type",
    "sec.policy.isolationSource": "Isolation source",
    "sec.policy.isolationSourcePlaceholder": "Sandbox/container or organizer environment",
    "sec.policy.changeReason": "Policy change reason",
    "sec.policy.reasonPlaceholder": "Reason",
    "sec.policy.defaultReason": "Competition task configuration",
    "sec.isolation.status.unverified": "unverified",
    "sec.isolation.status.sandbox": "sandbox",
    "sec.isolation.status.external": "external",
    "sec.isolation.type.sandbox": "pi-sandbox / container",
    "sec.isolation.type.external": "Organizer-controlled external isolation",
    "sec.scope.title": "Task and authorization scope",
    "sec.scope.goalNotExtracted": "Goal not extracted",
    "sec.scope.authorizedTargets": "Authorized targets",
    "sec.scope.authorizedTargetsPlaceholder": "One authorized host, CIDR, domain or URL per line",
    "sec.scope.authorizationSource": "Authorization source",
    "sec.scope.authorizationSourcePlaceholder": "Authorization source",
    "sec.scope.set": "Set scope",
    "sec.scope.noAuthorizedTargets": "No authorized targets",
    "sec.evidence.title": "Evidence and findings",
    "sec.evidence.summary": "{evidence} evidence · {hypotheses} hypotheses · {findings} findings",
    "sec.audit.title": "Decisions and tool audit",
    "sec.audit.summary": "{decisions} decisions · {calls} tool calls",
    "sec.audit.entry": "{status} {tool} · {decision}",
    "sec.audit.status.blocked": "BLOCK",
    "sec.audit.status.error": "ERROR",
    "sec.audit.status.ok": "OK",
    "sec.audit.decision.allow": "allow",
    "sec.audit.decision.confirm": "confirm",
    "sec.audit.decision.deny": "deny",
    "sec.audit.decision.warn": "warn",
    "sec.diagnostics.title": "Environment diagnostics",
    "sec.diagnostics.run": "Run diagnostics",
    "sec.diagnostics.summary": "runtime: {runtime} · autonomous: {autonomous} · demo: {demo}",
    "sec.diagnostics.status.pass": "PASS",
    "sec.diagnostics.status.warn": "WARN",
    "sec.diagnostics.status.fail": "FAIL",
    "sec.status.ready": "ready",
    "sec.status.blocked": "blocked",
    "sec.report.title": "Report",
    "sec.report.download": "Download",
