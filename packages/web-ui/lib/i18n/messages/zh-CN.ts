...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sec.error.invalidResponse": "Profile API 返回了无效响应",
    "sec.error.httpStatus": "HTTP {status}",
    "sec.error.invalidSnapshot": "Sec 配置返回了空快照或无效快照",
    "sec.error.sessionNotStarted": "安全会话尚未启动",
    "sec.error.codingSession": "当前会话是 Coding 会话，无法使用安全命令",
    "sec.error.invalidDiagnostics": "Sec 诊断返回了无效结果",
    "sec.error.invalidEvent": "实时安全状态事件无效",
    "sec.error.connectionFailed": "实时安全状态连接失败，浏览器将自动重试",
    "sec.error.scopeRequired": "至少提供一个授权目标",
    "sec.error.authorizationRequired": "必须提供授权来源；附件不会自动授予授权",
    "sec.error.autonomousIsolationRequired": "Autonomous 模式需要沙箱或受控的外部隔离来源",
    "sec.confirm.autonomous": "Autonomous 模式可能会在授权范围内执行 P2/P3 安全操作。确认当前为受控环境？",
    "sec.stage.notStarted": "尚未开始",
    "sec.stage.understanding": "任务理解",
    "sec.stage.planning": "规划",
    "sec.stage.recon": "侦察",
    "sec.stage.analysis": "分析",
    "sec.stage.verification": "验证",
    "sec.stage.response": "响应",
    "sec.stage.report": "报告",
    "sec.policy.mode.strict": "严格",
    "sec.policy.mode.competition": "比赛",
    "sec.policy.mode.autonomous": "自主",
    "sec.policy.title": "策略与隔离",
    "sec.policy.isolation": "隔离：{status}",
    "sec.policy.isolationType": "隔离类型",
    "sec.policy.isolationSource": "隔离来源",
    "sec.policy.isolationSourcePlaceholder": "沙箱/容器或主办方环境",
    "sec.policy.changeReason": "策略变更原因",
    "sec.policy.reasonPlaceholder": "原因",
    "sec.policy.defaultReason": "比赛任务配置",
    "sec.isolation.status.unverified": "未验证",
    "sec.isolation.status.sandbox": "沙箱",
    "sec.isolation.status.external": "外部隔离",
    "sec.isolation.type.sandbox": "pi-sandbox / 容器",
    "sec.isolation.type.external": "主办方控制的外部隔离",
    "sec.scope.title": "任务与授权范围",
    "sec.scope.goalNotExtracted": "尚未提取目标",
    "sec.scope.authorizedTargets": "授权目标",
    "sec.scope.authorizedTargetsPlaceholder": "每行填写一个授权主机、CIDR、域名或 URL",
    "sec.scope.authorizationSource": "授权来源",
    "sec.scope.authorizationSourcePlaceholder": "授权来源",
    "sec.scope.set": "设置范围",
    "sec.scope.noAuthorizedTargets": "没有授权目标",
    "sec.evidence.title": "证据与发现",
    "sec.evidence.summary": "{evidence} 条证据 · {hypotheses} 个假设 · {findings} 个发现",
    "sec.audit.title": "决策与工具审计",
    "sec.audit.summary": "{decisions} 个决策 · {calls} 次工具调用",
    "sec.audit.entry": "{status} {tool} · {decision}",
    "sec.audit.status.blocked": "阻断",
    "sec.audit.status.error": "错误",
    "sec.audit.status.ok": "成功",
    "sec.audit.decision.allow": "允许",
    "sec.audit.decision.confirm": "需确认",
    "sec.audit.decision.deny": "拒绝",
    "sec.audit.decision.warn": "告警",
    "sec.diagnostics.title": "环境诊断",
    "sec.diagnostics.run": "运行诊断",
    "sec.diagnostics.summary": "运行时：{runtime} · 自主：{autonomous} · 演示：{demo}",
    "sec.diagnostics.status.pass": "通过",
    "sec.diagnostics.status.warn": "警告",
    "sec.diagnostics.status.fail": "失败",
    "sec.status.ready": "就绪",
    "sec.status.blocked": "阻断",
    "sec.report.title": "报告",
    "sec.report.download": "下载",
