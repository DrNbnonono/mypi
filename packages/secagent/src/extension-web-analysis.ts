...
export function createSecAgentWebAnalysisExtension(runtime: SecAgentRuntime): SecAgentInlineExtension {
	return defineSecAgentExtension("secagent-web-analysis", (pi) => {
		...
		pi.registerTool<typeof WebExecuteParams, SecurityToolExecutionResult>({
			...
			description:
				"Execute constrained HTTP fingerprinting, bounded content discovery, or signed built-in nuclei templates through the audited Security Gateway.",
