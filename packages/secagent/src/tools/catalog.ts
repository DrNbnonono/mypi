...
export const SECURITY_TOOL_CATALOG: readonly SecurityToolMetadata[] = [
	...
	tool("file", "reverse", "P0", "none", ["binary.identify"], "Identify artifact format.", {
		agents: ["sec-reverse", "sec-analysis"],
	}),
	...
	tool(
		...
		"P0",
		"none",
		["binary.elf.inspect", "binary.mitigations.inspect"],
		"Inspect ELF structure and common exploit mitigations without executing the artifact.",
	...
	tool(
		...
		"none",
		["binary.disassemble"],
		"Inspect binary sections, symbols and disassembly without executing the artifact.",
		{ agents: ["sec-reverse", "sec-vuln"] },
	),
	...
	tool(
		...
		"P0",
		"none",
		["artifact.signature.scan", "forensics.embedded-content.identify"],
		"Scan local artifact signatures without automatic extraction.",
		{
			agents: ["sec-analysis", "sec-reverse"],
			postconditions: ["scan output is evidence, not an extracted artifact"],
		},
	),
	tool(
		"exiftool",
		...
		"P0",
		"none",
		["artifact.metadata.inspect", "forensics.metadata"],
		"Read local artifact metadata as structured JSON.",
		{ agents: ["sec-analysis", "sec-reverse"] },
	),
] as const;
